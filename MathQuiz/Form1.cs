...
namespace MathQuiz
{
    ...
    {
        //Creat a Rndom object called randomizer to generate random numbers.
        Random randomizer = new Random();

        //These integer varibales store the numbers for the addition problem.
        int addend1;
        int addend2;
        ...
        // This integer variable keeps track of the remaining time left
        int timeLeft;
        ...
        private void answer_Enter(object sender, EventArgs e)
        {
            ...
            if (answerBox != null)
            {
                int lenthOfAnswer = answerBox.Value.ToString().Length;
                answerBox.Select(0, lenthOfAnswer);
            }
